                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="text-dark form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="text-dark form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"
                                           placeholder="@lang('labels.Password')" type="password" name="password" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="profile" id="input-profile"
                                       ...
                                       placeholder="{{ __('User Profile') }}" value="" required>
                            </div>
                            <div class="row my-4">
                                <div class="col-12">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        <input class="custom-control-input" id="customCheckRegister" type="checkbox" checked>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-block btn-primary mt-4">@lang('labels.Create Accont')</button>
                            </div>
                        </form>
                    </div>
                </div>
